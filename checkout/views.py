from django.shortcuts import render, redirect, reverse, get_object_or_404, HttpResponse, request
...
try:
    ...
    messages.error(request, 'Something went wrong, please try your payment again later.')
